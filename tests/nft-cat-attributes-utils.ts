...
export function createNftCatAttributesCreatedEvent(
    ...
    let nftCatAttributesCreatedEvent = changetype<NftCatAttributesCreated>(newMockEvent())
    ...
    nftCatAttributesCreatedEvent.parameters.push(
        new ethereum.EventParam("breed", ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(breed)))
    )
    nftCatAttributesCreatedEvent.parameters.push(
    ...
    nftCatAttributesCreatedEvent.parameters.push(
        new ethereum.EventParam("playfulness", ethereum.Value.fromUnsignedBigInt(playfulness))
    )
    nftCatAttributesCreatedEvent.parameters.push(
        new ethereum.EventParam("cuteness", ethereum.Value.fromUnsignedBigInt(cuteness))
    )
...
export function createNftCatAttributesRequestedEvent(
    ...
    let nftCatAttributesRequestedEvent = changetype<NftCatAttributesRequested>(newMockEvent())
