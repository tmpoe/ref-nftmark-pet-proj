...
describe("Describe entity assertions", () => {
    beforeAll(() => {
        ...
        let ierc721TokenAddress = Address.fromString("0x0000000000000000000000000000000000000001")
        let newNftListedEvent = createNftListedEvent(nftId, owner, price, ierc721TokenAddress)
